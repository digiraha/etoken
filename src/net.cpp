...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eToken " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    //{"digiraha.ee", "dnsseed.etoken.digiraha.ee"}
	{NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x1134f5c6, 0x8da01fb0, 0x8aa01fb0
/*
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eToken is probably already running."), addrBind.ToString().c_str());
        else
